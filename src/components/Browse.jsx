...
const Browse = () => {
    ...
    return (
        <div className='w-full h-screen bg-zinc-950 overflow-hidden'>
            ...
            <DetsNav />
            <form className='max-w-screen-md justify-center gap-4 flex items-center relative mx-auto min-h-[11%] py-5 rounded-md mt-5 bg-zinc-400/20 backdrop-blur-sm shadow-2xl'>
