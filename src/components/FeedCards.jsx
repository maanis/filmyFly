  ...
  return data.length > 0 ? (
    <div className={`w-full max-md:relative ${title === '' && 'max-md:top-[65%]'} flex max-md:flex-wrap   gap-3 min-md:overflow-x-auto max-md:justify-center  h-[28%] px-3 py-2`}>
      {data.map((d, i) => (
        ...
        }} className={`w-[9rem] max-[768px]:w-[10rem] max-[640px]:w-[8rem] max-[432px]:w-[10rem] ${title != 'tv' && 'max-[432px]:h-[108%]'} min-[976px]:w-[8rem] transition-all relative rounded-md cursor-pointer h-full shrink-0`}>
