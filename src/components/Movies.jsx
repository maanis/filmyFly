        ...
        <>
            ...
            <div className='min-h-full w-[94%] relative left-[5%]'>
                ...
                <div className="nav w-full h-[9%] shadow-lg flex justify-between items-center px-4">
                    <p className='text-2xl font-semibold'>Movie <small className='text-sm text-zinc-600'>({category})</small></p>
                    <Dropdown options={['now_playing', 'popular', 'top_rated', 'upcoming']} method={setcategory} />
                </div>
                <InfiniteScroll
