...
const Topnav = ({ search }) => {
    ...
    return (
        <div className={`flex relative w-[26rem]  items-center max-[768px]:w-[20rem] max-[482px]:w-full max-[482px]:absolute max-[482px]:left-0  ${search ? 'max-[482px]:top-[100%]' : 'max-[482px]:top-[-100%]'} transition-all `}>
            ...
            <input value={input} onChange={(e) => setinput(e.currentTarget.value)} className='w-full max-[482px]:w-full  border-1 text-white border-zinc-400 text-2xl px-10 max-md:px-8 py-2  max-md:h-[2rem] outline-none rounded-md shadow-md' type="text" name="" id="" />
